...
<!--      <el-table-column label="文章链接" align="center" prop="link" />-->
      ...
      <el-table-column label="发布时间" align="center" prop="publicTime">
        <template slot-scope="scope">
...
<!--      </el-table-column>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="文章链接" prop="link">
          <el-input v-model="form.link" placeholder="请输入文章链接" />
        </el-form-item>
        <el-form-item label="阅读数" prop="readCount">
          <el-input v-model="form.readCount" placeholder="请输入阅读数" />
        </el-form-item>
        <el-form-item label="点赞数" prop="likeCount">
...
<script>
import { listGzh, getGzh, delGzh, addGzh, updateGzh } from "@/api/spider/gzh";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listGzh(this.queryParams).then(response => {
        this.gzhList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateGzh(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addGzh(this.form).then(response => {
